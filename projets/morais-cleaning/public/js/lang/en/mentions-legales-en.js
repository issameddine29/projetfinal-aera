/**
* TRADUCTION ANGLAISE - MENTIONS-LEGALES.HTML
* Basic translation - to be completed
*/

window.applyTranslations = function() {
    // console.log('🌍 Applying English translations for mentions-legales.html...');

    try {
        // === TITLE ===
        document.title = 'Legal Notice - Morais Cleaning';
        ...
        // console.log('English translations applied (mentions-legales)');

    } catch (error) {
        // console.error('❌ Error applying English translations (mentions-legales):', error);
    }
};
