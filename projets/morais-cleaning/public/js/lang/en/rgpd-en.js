/**
* TRADUCTION ANGLAISE - RGPD.HTML
* Basic translation - to be completed
*/

window.applyTranslations = function() {
    // console.log('🌍 Applying English translations for rgpd.html...');

    try {
        // === TITLE ===
        document.title = 'GDPR - Morais Cleaning';
        ...
        // console.log('English translations applied (rgpd)');

    } catch (error) {
        // console.error('❌ Error applying English translations (rgpd):', error);
    }
};
