/**
* TRADUCTION ANGLAISE - CONDITIONS-GENERALES.HTML
* Basic translation - to be completed
*/

window.applyTranslations = function() {
    // console.log('🌍 Applying English translations for conditions-generales.html...');

    try {
        // === TITLE ===
        document.title = 'Terms & Conditions - Morais Cleaning';
        ...
        // console.log('English translations applied (conditions-generales)');

    } catch (error) {
        // console.error('❌ Error applying English translations (conditions-generales):', error);
    }
};
